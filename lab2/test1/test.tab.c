...
{
       0,   256,   257,   258,    43,    45,    42,    47,   259,    59,
      40,    41
};
# endif
...
#line 22 "test.y"
                       { printf("%f\n", yyvsp[-1]); }
#line 1309 "test.tab.c"
    break;

  case 5:
#line 27 "test.y"
                     { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1315 "test.tab.c"
    break;
...
#line 29 "test.y"
                { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1327 "test.tab.c"
    break;

  case 8:
#line 30 "test.y"
                { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1333 "test.tab.c"
    break;
...
#line 33 "test.y"
         { yyval = yyvsp[0]; }
#line 1351 "test.tab.c"
    break;


#line 1355 "test.tab.c"
