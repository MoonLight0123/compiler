...
protected:
    ...
    enum {BINARY, COND, UNCOND, RET, LOAD, STORE, CMP, ALLOCA, CALL, EXT,GEP};
};
...
private:
    SymbolEntry *arraySe;
public:
    GEPInstruction(Operand *dst,Operand *base,Operand *baseOffset,std::vector<Operand*> &dimsValAddr, SymbolEntry*arraySe, BasicBlock *insert_bb = nullptr);
    ~GEPInstruction();
    void output() const;
    void genMachineCode(AsmBuilder*);
};
