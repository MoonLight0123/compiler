...
%nterm <stmttype> DeclStmt FuncDef IdDeclLists IdDeclList ConstDeclLists ConstDeclList WhileStmt FuncFParam FuncFParams FuncCallStmt EmptyStmt VarDeclStmt ConstDeclStmt ConstArrayDims ArrayDims FuncFArrayParamDims 
...
FuncFParam
    ...
    |
    Type ID LBRACKET RBRACKET FuncFArrayParamDims {
        SymbolEntry *se;
        se = new IdentifierSymbolEntry($1, $2, identifiers->getLevel());
        identifiers->install($2, se);
